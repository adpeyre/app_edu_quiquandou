...
class ThumbnailController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $thumbnails = $em->getRepository('ExerciceBundle:Thumbnail')->findAll();

        return $this->render('ExerciceBundle:thumbnail:index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('ExerciceBundle\Form\ThumbnailType', $thumbnail);
        ...
        return $this->render('ExerciceBundle:thumbnail:new.html.twig', array(
            'thumbnail' => $thumbnail,
    ...
    public function showAction(Thumbnail $thumbnail)
    {
        ...
        return $this->render('ExerciceBundle:thumbnail:show.html.twig', array(
            'thumbnail' => $thumbnail,
    ...
    {
        $deleteForm = $this->createDeleteForm($thumbnail);
        $editForm = $this->createForm('ExerciceBundle\Form\ThumbnailType', $thumbnail);
        ...
        return $this->render('ExerciceBundle:thumbnail:edit.html.twig', array(
            'thumbnail' => $thumbnail,
